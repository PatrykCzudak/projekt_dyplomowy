...
# Tworzymy listę tickerów (o dużej różnorodności)
...
# UTIL: sprawdzamy czy coś już zostało pobrane
...
# QUICK TEST: Do pobrania jednego tickera np
...
# MERGE: końcowy df z wszystkimi tickerami
